...
\                    ."<body>\n\t${child}|\n</body>\n"
\                    ."</html>",
\           'phtml:5': "<?php defined('SYSPATH') or die('No direct script access.');?><!DOCTYPE HTML>\n"
\                    ."<head>\n"
\                    ."    <meta charset=\"UTF-8\">\n"
\                    ."    <?php echo HTML::style('common/base.css'); ?>\n"
\                    ."    <?php echo HTML::style('common/app.css'); ?>\n"
\                    ."    <?php echo HTML::script('common/jquery-1.8.3.min.js'); ?>\n"
...
\   'sql': {
\       'snippets': {
\           'drop': "DROP TABLE IF EXISTS `${child}|`;\n",
\           'create': "CREATE TABLE `${child}|` (\n\n\n) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;\n\n",
\           'fid': "`${child}|` int(10) unsigned NOT NULL AUTO_INCREMENT,\n",
\           'fvc': "`${child}|` varchar(255) NOT NULL DEFAULT '',\n",
\           'fc': "`${child}|` char(25) NOT NULL DEFAULT '',\n",
\           'fint': "`${child}|` int(10) unsigned NOT NULL DEFAULT '0',\n",
\           'ftint': "`${child}|` tinyint(3) unsigned NOT NULL DEFAULT '0',\n",
\           'ftext': "`${child}|` text,\n",
\           'ftime': "`${child}|` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,\n",
\           'ftimeu': "`${child}|` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,\n",
\           'fkey': "PRIMARY KEY (`${child}|`)\n",
\           'ald': "ALTER TABLE `${child}|`  DROP \n",
\           'alc': "ALTER TABLE `${child}|` CHANGE \n",
\           'ala': "ALTER TABLE `${child}|` ADD  \n"
\       },
\   }
\}
