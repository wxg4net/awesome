...
titlebar_clients = {"Gcolor2", "MPlayer", "Gnome-mplayer", "Xmradio", "Gmchess"}
...
awful.rules.rules = {
    ...
    { rule_any = { class = {"Chromium", "Google-chrome-unstable", "Google-chrome-beta", "Google-chrome"} },
