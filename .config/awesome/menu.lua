 local menuc8205c7636e728d448c2774e6a4a944b = {
     ...
     {"Mumble", "mumble"},
     {"OpenFetion(飞信)", "openfetion", "/usr/share/pixmaps/fetion.svg" },
 ...
 local menude71492af019157e5a5ef958b570e760 = {
     ...
     {"搜狗拼音", "fcitx-qimpanel ", "/usr/share/icons/hicolor/16x16/apps/fcitx-sogoupinyin.png" },
 ...
 local menuc9a6ee90f5d43732e3f6cf4dcaa8493c = {
     ...
     {"快捷方式编辑器", "lxshortcut -i ", "/usr/share/icons/gnome/16x16/categories/applications-other.png" },
